...
import dev.nandi0813.practice.module.interfaces.ConfigItemProvider;
...
/**
 * Legacy (1.8.8) implementation of ConfigItemProvider.
 * In 1.8, the DAMAGE value is used for item data/color (e.g., wool colors, glass colors).
 */
public class LegacyConfigItemProvider implements ConfigItemProvider {

    @Override
    public GUIItem getGuiItem(YamlConfiguration config, String loc) {
